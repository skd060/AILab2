    ...
    //#include<queue>
    using namespace std;
    void sum(int k , vector<vector<int> > v);
    ...
    int sum(vector<vector<int> > myvec1){
    	int i,count=0;
    	for (int j = 0; j<myvec1.size(); j++)
    	{
    ...
    void func(vector<vector<int> >&myvec,int k)
    {
